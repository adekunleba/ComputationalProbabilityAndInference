...
def print_joint_prob_table_dict(dicts_in_dict):
    ...
    - dicts_in_dict: joint probability table stored as dictionaries within a
      dictionary
    """
    #Uses Datafram Transpose index and columns
...
for w in {'sunny', 'rainy', 'snowy'}:
    prob_W_T_dict[w] = {} #create an empty dictionary for the set of w

#Create values for each Temperature instance of the set w
...
#Retrieving values from the array representation
...
#Use the index ascribed to obtain the probability of a w and t
