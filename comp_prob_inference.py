...
#Trying out on Events  Codes here were used in the class.   
...
#Coding up probability of an event
...
for i in range(1, 10):
    sample_weather = sample_from_finite_probability_space(prob_space)
    if sample_weather == 'snowy':
        I = 1
    else:
        I = 0
    print('For round {} :'.format(i), I)